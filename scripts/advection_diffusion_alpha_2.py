...
fig, ax = plt.subplots()
ax.plot(alpha_range, b_invs_2, label='Measured')
...
fig, ax = plt.subplots()
ax.plot(alpha_range, ys)
ax.plot(alpha_range, np.array(b_invs) * np.array(fourier_norms),
        'r--')
ax.set_xscale('log')
ax.set_yscale('log')
plt.show()
...
fig, ax = plt.subplots()
ax.plot(alpha_range, np.array(b_invs) * np.array(fourier_norms)/np.array(ys))
ax.set_xscale('log')
ax.set_yscale('log')
plt.show()